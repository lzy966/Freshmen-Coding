...
if __name__ == '__main__':
    device = 'cpu'
    tokenizer = AutoTokenizer.from_pretrained('D:/Jupyter notebook file/硕士/PLM/Text Matching/SimCSE/model_best')
    model = torch.load('D:/Jupyter notebook file/硕士/PLM/Text Matching/SimCSE/model_best/model.pt',weights_only=False)
