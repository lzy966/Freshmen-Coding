...
# # 设置 utils.py 中的全局变量
# import utils
# utils.label2id = label2id
sys.argv = [
    'train.py',
    '--model', 'bert-base-chinese',
    '--train_path', 'D:/Data/master/Freshmen Coding Assignment/NLP/comment_classify/train3.txt',
    '--dev_path', 'D:/Data/master/Freshmen Coding Assignment/NLP/comment_classify/dev3.txt',
