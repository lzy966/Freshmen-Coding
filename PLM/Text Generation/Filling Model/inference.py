...
tokenizer = AutoTokenizer.from_pretrained('D:/Jupyter notebook file/硕士/PLM/Text Generation/Filling Model/model_best/')
model = T5ForConditionalGeneration.from_pretrained('D:/Jupyter notebook file/硕士/PLM/Text Generation/Filling Model/model_best/')
