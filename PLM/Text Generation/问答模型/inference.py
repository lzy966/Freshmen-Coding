...
tokenizer = AutoTokenizer.from_pretrained('D:/Jupyter notebook file/硕士/PLM/Text Generation/问答模型/model_best/')
model = T5ForConditionalGeneration.from_pretrained('D:/Jupyter notebook file/硕士/PLM/Text Generation/问答模型/model_best/')
