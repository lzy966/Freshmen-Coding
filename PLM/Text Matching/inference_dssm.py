...
device = 'cpu'                                                        # 指定GPU设备
saved_model_path = 'D:/Jupyter notebook file/硕士/PLM/Text Matching/DSSM/model_best/'     # 训练模型存放地址
tokenizer = AutoTokenizer.from_pretrained(saved_model_path) 
model = torch.load(os.path.join(saved_model_path, 'model.pt'),weights_only=False)
model.to(device).eval()
type_desc_dict = json.load(open('D:/Data/master/Freshmen Coding Assignment/NLP/comment_classify/dssm_type_embeddings.json', \
