...
device = 'cpu'
model_path = 'D:/Jupyter notebook file/硕士/PLM/Prompt Tasks/p-turning/model_best'
...
def inference(contents: List[str]):
    ...
    with torch.no_grad():
        ...
        if 'token_type_ids' not in tokenized_output:
            tokenized_output['token_type_ids'] = torch.zeros_like(tokenized_output['input_ids'])
