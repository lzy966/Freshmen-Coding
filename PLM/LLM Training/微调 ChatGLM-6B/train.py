...
sys.argv = [
    "train.py",
    "--train_path", "D:/Data/master/Freshmen Coding Assignment/NLP/LLM training_data/mixed_train_dataset.jsonl",
    "--dev_path", "D:/Data/master/Freshmen Coding Assignment/NLP/LLM training_data/mixed_dev_dataset.jsonl",
    "--use_lora", "True",
    "--lora_rank", "8",
    "--batch_size", "1",
    "--num_train_epochs", "2",
    ...
    "--save_dir", "D:/Jupyter notebook file/硕士/PLM/LLM Training/微调 ChatGLM-6B/finetune",
    "--img_log_dir", "D:/Jupyter notebook file/硕士/PLM/LLM Training/微调 ChatGLM-6B/fintune_log",
