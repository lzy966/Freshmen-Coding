...
text_file = 'D:/Data/master/Freshmen Coding Assignment/NLP/comment_classify/types_desc.txt'                       # 候选文本存放地址
output_file = 'D:/Data/master/Freshmen Coding Assignment/NLP/comment_classify/sentence_transformer_type_embeddings.json'    # embedding存放地址
device = 'cpu'                                                        # 指定GPU设备
model_type = 'sentence_transformer'                                                      # 使用DSSM还是Sentence Transformer
saved_model_path = 'D:/Jupyter notebook file/硕士/PLM/Text Matching/SentenceTransformer/model_best/'     # 训练模型存放地址
tokenizer = AutoTokenizer.from_pretrained(saved_model_path) 
model = torch.load(os.path.join(saved_model_path, 'model.pt'),weights_only=False)
