...
sys.argv = [
    ...
    "--save_dir", "D:/Jupyter notebook file/硕士/PLM/Text Matching/PointWise",
    "--img_log_dir", "D:/Jupyter notebook file/硕士/PLM/Text Matching/PointWise",
...
parser.add_argument('--device', default="cpu", help="Use CPU instead of GPU.")
...
def train():
    assert args.train_path is not None and os.path.exists(args.train_path), f"Invalid or missing train_path: {args.train_path}"
    assert args.dev_path is not None and os.path.exists(args.dev_path), f"Invalid or missing dev_path: {args.dev_path}"
    train_path = args.train_path
    dev_path = args.dev_path
    print("train_path:", train_path, type(train_path))
    print("dev_path:", dev_path, type(dev_path))
